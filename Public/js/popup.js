...
function popup(content,mark,url) {
    ...
    cross.style.cssText = "float:right;cursor:pointer;margin-right:10px;margin-top: 10px;line-height:26px; background-color: white;color:black;width: 20px;height: 20px;color:black;text-align: center;font-size: 23px;";
    cross.innerHTML = 'X';
    ...
    clearDiv.style.cssText = "clear:both";
     ...
     var contetDiv = document.createElement("DIV");
        contetDiv.style.cssText = "margin: 10px; line-height: 36px;font-size: 16px;font-family:'Microsoft YaHei';color: rgb(89, 88, 88);";
