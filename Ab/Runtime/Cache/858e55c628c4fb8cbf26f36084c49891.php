<?php if (!defined('THINK_PATH')) exit();?><div id="winTit"><em id="Countdown">60</em><dl><dt>交易单</dt><dd>目前余额:<?php echo ($credit); ?></dd></dl><span onclick='hide();'>×</span></div>
<form name="orderForm" id="orderForm" method="post" action="/index.php/Bet/Ft_bet" target="betorderform">
    <div class="order-info">
        ...
        <br /><?php echo ($M_Place); ?> @ <strong><?php echo ($M_Rate); ?></strong>
    </div>
    <div class="bet-info">
        <dl>
